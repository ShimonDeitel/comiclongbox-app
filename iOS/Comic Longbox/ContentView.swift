...
struct ContentView: View {
    ...
    @State private var editingItem: Issue?
    ...
    private func subtitle(for item: Issue) -> String {
        var parts: [String] = []
        
        parts.append("IssueNumber: " + describeField(item.issueNumber))
...
struct ItemFormView: View {
    ...
    init(mode: FormMode) {
        ...
        switch mode {
        case .add:
            _draft = State(initialValue: Issue(id: UUID(), title: String = "", issueNumber: Int = 0, condition: String = "", notes: String = ""))
        case .edit(let item):
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Stepper("IssueNumber: \(draft.issueNumber)", value: $draft.issueNumber, in: 0...100000)
                    .accessibilityIdentifier("field_issueNumber")
